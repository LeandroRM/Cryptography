 ...
 *
 */
public class VigenereWheelCipher {
    ...
    public VigenereWheelCipher(String message, String keyword) {
    ...
    public static void main(String[] args) {
        ...
        VigenereWheelCipher cipher = new VigenereWheelCipher(message, keyword);
